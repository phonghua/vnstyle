...
var addComment = {
  moveForm: function(a, b, c, d) {
    ...
    if (j && k && l && m && o) {
      (i.respondId = c), (d = d || !1), i.I("wp-temp-form-div") ||
        (
          (e = document.createElement("div")),
          (e.id = "wp-temp-form-div"),
          (e.style.display = "none"),
          k.parentNode.insertBefore(e, k)
        ), j.parentNode.insertBefore(k, j.nextSibling), n &&
        d &&
        (n.value = d), (m.value = b), (l.style.display =
        ""), (l.onclick = function() {
        var a = addComment,
          b = a.I("wp-temp-form-div"),
          c = a.I(a.respondId);
        if (b && c)
          return (a.I("comment_parent").value = "0"), b.parentNode.insertBefore(
            c,
            b
          ), b.parentNode.removeChild(b), (this.style.display =
            "none"), (this.onclick = null), !1;
      });
      try {
...
!(function(e) {
  ...
  (n.fileapi =
    void 0 !==
    e("<input type='file'/>").get(0)
      .files), (n.formdata = void 0 !== window.FormData);
  var i = !!e.fn.prop;
  (e.fn.attr2 = function() {
            ...
            r.upload.addEventListener(
              ...
              function(e) {
                var r = 0,
                  ...
                  n = e.total;
                e.lengthComputable &&
                  (r = Math.ceil(a / n * 100)), t.uploadProgress(e, a, n, r);
              },
              !1
            ), r;
        }), (s.data = null);
    ...
    function s(r) {
      ...
      function o() {
        ...
        w.setAttribute("target", p), (!u || /post/i.test(u)) &&
          w.setAttribute("method", "POST"), i != m.url &&
          w.setAttribute("action", m.url), m.skipEncodingOverride ||
          (u && !/post/i.test(u)) ||
          f.attr({
        ...
        try {
          ...
          m.iframeTarget || v.appendTo("body"), g.attachEvent
            ? g.attachEvent("onload", s)
            : g.addEventListener("load", s, !1), setTimeout(t, 15);
          try {
            w.submit();
          } catch (h) {
          ...
          w.setAttribute("action", i), w.setAttribute("enctype", c), r
        ...
        if (!x.aborted && !F) {
          ...
          if ((M && M.location.href != m.iframeSrc) || T) {
            ...
            try {
              ...
              (x.responseText = u
                ? u.innerHTML
                : null), (x.responseXML = M.XMLDocument
                ? M.XMLDocument
                : M), o &&
                (m.dataType = "xml"), (x.getResponseHeader = function(e) {
              ...
              if (l || m.textarea) {
                ...
                if (f)
                  (x.responseText = f.value), (x.status =
                    Number(f.getAttribute("status")) ||
            ...
            x.aborted && (a("upload aborted"), (i = null)), x.status &&
              (i =
              ...
              : i &&
                ...
                ), d && e.event.trigger("ajaxComplete", [x, m]), d &&
              !--e.active &&
              e.event.trigger("ajaxStop"), m.complete &&
              m.complete.call(m.context, x, i), (F = !0), m.timeout &&
              clearTimeout(j), setTimeout(function() {
              m.iframeTarget
                ? v.attr("src", m.iframeSrc)
                : v.remove(), (x.responseXML = null);
            }, 100);
          }
        }
      }
        ...
        (
          ...
          (x = {
            ...
            abort: function(t) {
              ...
              v.attr("src", m.iframeSrc), (x.error = r), m.error &&
                m.error.call(m.context, x, r, t), d &&
                e.event.trigger("ajaxError", [x, m, r]), m.complete &&
                m.complete.call(m.context, x, r);
            }
          }),
          (d = m.global),
      ...
      L &&
        A &&
        ((m.extraData = m.extraData || {}), (m.extraData[L] = A)), m.forceSync
        ? o()
        : setTimeout(o, 10);
      var E,
        M,
        ...
        X =
          ...
          function(e, t) {
            return window.ActiveXObject
              ...
              : (t = new DOMParser().parseFromString(e, "text/xml")), t &&
            t.documentElement &&
        ...
        _ = function(t, r, a) {
          ...
          return i &&
            ...
            e.error &&
            e.error("parsererror"), a &&
            a.dataFilter &&
            (o = a.dataFilter(o, r)), "string" == typeof o &&
    ...
    "function" == typeof t
      ? (t = { success: t })
      : void 0 === t && (t = {}), (u = t.type || this.attr2("method")), (c =
      t.url || this.attr2("action")), (l =
      "string" == typeof c ? e.trim(c) : ""), (l =
      l || window.location.href || ""), l &&
      (l = (l.match(/^([^#]+)/) || [])[1]), (t = e.extend(
      !0,
      {
        url: l,
    ...
    var g = e.param(v, d);
    p && (g = g ? g + "&" + p : p), "GET" == t.type.toUpperCase()
    ...
    return void 0 === t && (t = !0), this.each(function() {
      ...
      if ("checkbox" == r || "radio" == r) this.checked = t;
        ...
        t &&
          a[0] &&
          "select-one" == a[0].type &&
          a.find("option").selected(!1), (this.selected = t);
      }
    });
